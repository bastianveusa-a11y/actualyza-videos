      ...
      <IPhoneMockup width={360} style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: "0 0 14px rgba(76,142,255,0.5)",
            flexShrink: 0,
          }}>
        ...
        <div style={{
          ...
          {chat.messages.map((msg, i) => {
            ...
            return (
              <div key={i} style={{
                display: "flex",
                justifyContent: isAmy ? "flex-start" : "flex-end",
                opacity: s,
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    fontSize: 14,
                    lineHeight: 1.5,
                    color: isAmy ? "#e8f0ff" : "rgba(255,255,255,0.8)",
                    fontFamily: isAmy ? "'Playfair Display', serif" : "'Inter', sans-serif",
                    fontStyle: isAmy ? "italic" : "normal",
                    fontWeight: isAmy ? 400 : 300,
                  }}>
                    {msg.text}
                  </p>
                </div>
          ...
          {frame > 150 && frame < 185 && (
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <div style={{
                background: "#1e3a5f",
                border: "1px solid rgba(76,142,255,0.3)",
                ...
                {[0,1,2].map(i => (
                  <div key={i} style={{
                    width: 6, height: 6, borderRadius: "50%", background: "#4C8EFF",
                    opacity: interpolate(
                      (frame + i * 8) % 24,
                      [0, 8, 16, 24],
                      [0.3, 1, 0.3, 0.3],
        ...
        <div style={{
          ...
          <div style={{
            flex: 1, background: "#2c2c2e", borderRadius: 20,
            padding: "8px 14px", fontSize: 14, color: "rgba(255,255,255,0.25)",
            fontFamily: "'Inter', sans-serif",
          }}>
            iMessage
          </div>
